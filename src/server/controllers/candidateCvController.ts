...
export async function getProfileExtractedDataController(
  request: Request,
  response: Response<IApiSuccessResponse<IProfileExtractedDataResponse>>,
): Promise<void> {
  const extractedData = await getProfileExtractedData(
