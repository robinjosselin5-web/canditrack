...
export function buildCandidateCvAnalysisPrompt(extractedText: string): string {
  ...
  return [
    ...
    'Categories de competences autorisees: SPOKEN_LANGUAGES, PROGRAMMING_LANGUAGES, FRAMEWORKS_LIBRARIES, TOOLS_TECHNOLOGIES, METHODOLOGIES, SOFT_SKILLS, OTHER.',
    ...
    'Les langues humaines parlees ou ecrites, par exemple Francais, Anglais, Espagnol ou Allemand, doivent etre classees dans SPOKEN_LANGUAGES.',
    'Les langages de programmation, de script, de requete ou de balisage, par exemple JavaScript, TypeScript, Python, Java, SQL, HTML ou CSS, doivent etre classes dans PROGRAMMING_LANGUAGES.',
    'Ne jamais classer une langue humaine dans PROGRAMMING_LANGUAGES. Ne jamais classer un langage informatique dans SPOKEN_LANGUAGES.',
    'Exemples de competences valides: {"name":"Anglais","category":"SPOKEN_LANGUAGES","confidence":0.98,"source":"English fluent"} et {"name":"TypeScript","category":"PROGRAMMING_LANGUAGES","confidence":0.98,"source":"Developpement TypeScript"}',
